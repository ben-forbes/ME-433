...
void ws2812b_setup() {
    ...
    TRISBbits.TRISB6 = 0; // set output
    LATBbits.LATB6 = 0; // initialize output as off
}
...
void ws2812b_setColor(wsColor * c, int numLEDs) {
    ...
    volatile unsigned int delay_times[numBits]; // 
    // start at time at 0
    delay_times[0] = 0;
