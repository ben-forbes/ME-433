...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/nu32dip.o: nu32dip.c  .generated_files/flags/default/6d1ef5bc11531d7d05fe596ab8afa2c471ca4edd .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/HW5.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    NU32DIPbootloaded.LD.txt
	@${MKDIR} ${DISTDIR} 
