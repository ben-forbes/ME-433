...
import serial
ser = serial.Serial('/dev/tty.usbmodem141201',230400) # the name of your Pico port
print('Opening port: ')
print(ser.name)
...
ser.close()# Write your code here :-)

# white is equal parts all red blue and green
# black might look super green
